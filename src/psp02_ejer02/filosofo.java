...
public class filosofo extends Thread {
    ...
    //constructor
    public filosofo(int id_filosofo, Semaphore[] semaforos_palillos, int[][] palillos_filosofos) {
    ...
    public void run() {
        ...
        while (true) {
            try {
                sleep(500);//le damos tiempo antes de que vuelva a intentar empezar a comer de nuevo y haya menos mensajes de OCUPADO
